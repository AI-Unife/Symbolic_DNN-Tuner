...
parser.add_argument("--mode", type=str, default="depth", help="Mode for the experiment (fwdPass, depth or hybrid)")
parser.add_argument("--channels", type=int, default=16, help="Number of channels for the dataset")
