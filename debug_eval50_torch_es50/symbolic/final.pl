l([2.3210272410559276, 2.318303217963567]).
sl([2.3210272410559276, 2.3199376318189833]).
a([0.084, 0.097]).
sa([0.084, 0.0892]).
vl([2.317669013189891, 2.3156343755267916]).
va([0.086, 0.086]).
int_loss(2.3166516943583413).
int_slope(2.3166516943583413).
lacc(0.2).
hloss(2.302585092994046).
grad_global_norm(1.0).
vanish_th(1e-08).
exploding_th(100.0).
hw_latency(5.7868999999999994e-11).
max_latency(0.008).
