l([2.1675748601555824, 1.8721151277422905]).
sl([2.1675748601555824, 2.0493909671902655]).
a([0.226, 0.321]).
sa([0.226, 0.264]).
vl([2.5389427095651627, 2.4101037085056305]).
va([0.112, 0.164]).
int_loss(2.4745232090353966).
int_slope(2.4745232090353966).
lacc(0.2).
hloss(2.302585092994046).
grad_global_norm(1.0).
vanish_th(1e-08).
exploding_th(100.0).
hw_latency(1.0310599999999998e-10).
max_latency(0.008).
