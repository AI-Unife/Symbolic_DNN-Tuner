...
0.4::action(reg_l2,overfitting):- problem(overfitting).
0.4::action(inc_dropout,overfitting):- problem(overfitting).
0.6::action(data_augmentation,overfitting):- problem(overfitting).
0.3::action(dec_neurons,overfitting):- problem(overfitting).
0.3::action(dec_fc, overfitting):- problem(overfitting).
0.3::action(dec_layers,overfitting):- problem(overfitting).


0.2::action(decr_lr,underfitting):- problem(underfitting).
