...
def fase_analisi():
    ...
    if st.session_state.stato_bottone_confronto and not st.session_state.salvato_tutto:     # se sono nella modalità grafici di confronto, mostro i grafici di confronto per tutti gli esperimenti selezionati
