l([2.373382903635502, 2.3680851608514786]).
sl([2.373382903635502, 2.3712638065218927]).
a([0.096, 0.111]).
sa([0.096, 0.10200000000000001]).
vl([2.3436545357108116, 2.346698947250843]).
va([0.089, 0.097]).
int_loss(2.3451767414808273).
int_slope(2.3451767414808273).
lacc(0.2).
hloss(2.302585092994046).
grad_global_norm(1.0).
vanish_th(1e-08).
exploding_th(100.0).
hw_latency(5.7456e-11).
max_latency(0.008).
...
1e-05::action(dec_neurons,out_range):-problem(out_range).
